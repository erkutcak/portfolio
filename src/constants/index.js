import {
  ...
  const experiences = [
    ...
    {
      title: "Sr. Crime & Data Analyst / Software Development (6 months)",
      company_name: "My Security Analytics",
      icon: mysa,
      iconBg: "#E6DEDD",
      date: "Jun 2020 - Nov 2022",
      points: [
        "Created and developed the first and only automated Background Screening software in Turkey “FinalCheck”.",
        "Conducted OSINT (Open-Source Intelligence) Investigations utilizing entity-link analysis tools (Blackdot Videris, IBM i2 Analyst's Notebook, Maltego) to gather open-source information on individuals.",
        "Prepared Reputation, Risk, Anti-Money Laundering & Financial Background Check, and Soft-Due Diligence reports on companies and individuals aiming to detect financial anomalies and malicious behavior.",
        "Prepared Black Market Research projects on illegal products and their sales on social media and e-commerce.",
      ],
    },
    {
      ...
      icon: bcs,
      iconBg: "#383E56",
      date: "Nov 2016 - Jun 2020",
      points: [
        "Managed 5+ employees throughout the company.",
        "Monitored budget while constantly developing and implementing financial strategies to achieve optimum revenue and cost reduction.",
        "Managed multiple projects at a time from beginning to end and prioritize workload within the group to ensure that project timelines are met.",
        "Planned and coordinated all aspects of the construction process, including hiring contractors, working with engineers, architects, and vendors, communicating with customers, creating and following up with new leads.",
      ],
    },
    {
      ...
      points: [
        "Advised on the potential partnerships of UNDP RBEC with the private sector companies.",
        "Developed a note about the main Turkish companies that have investments in RBEC region.",
        "Designed a visit plan for the main NGOs and think-tanks, with whom UNDP can work in Istanbul.",
        "Developed new strategies on private sector partnership with UN bodies.",
      ],
    },
  ];
