...
const Navbar = () => {
  ...
  return (
    <nav
      className={`${styles.paddingX} w-full flex items-center py-5 fixed top-0 z-20 bg-primary/70`}
    >
      <div className='w-full flex justify-between items-center max-w-7xl mx-auto'>
        ...
        >
          ...
          <p className='text-white text-[18px] font-bold cursor-pointer flex'>Erkut Cakmak &nbsp;<span className='sm:block hidden font-light tracking-widest'>| Portfolio Website</span></p>
        </Link>
